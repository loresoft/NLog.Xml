...
{
    /// <summary>
    /// <see cref="LogEvent"/> XML reader
    /// </summary>
    public class LogEventReader
    {
        /// <summary>
        /// Reads a log event from the specified <paramref name="reader"/>.
        /// </summary>
        /// <param name="reader">The <see cref="XmlReader"/> to read from</param>
        /// <returns>An instance of <see cref="LogEvent"/> read from the XML</returns>
